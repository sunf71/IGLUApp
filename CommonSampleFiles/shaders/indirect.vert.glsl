...
layout (location = 10) in int draw_id;
out vec4 FogParam;
...
void main(void) {
    ...
    vec4 ObjectSpacePosition = texelFetch(InstanceData, draw_id*2) + vec4(VertexPosition, 1.0);
	//vec4 ObjectSpacePosition = vec4(VertexPosition, 1.0);
