...
struct is_Triangle
{
	__forceinline__ __host__ __device__ is_Triangle(uint32 id):_id(id)
	{}
...
struct is_Frustum
{
	__forceinline__ __host__ __device__ is_Frustum(uint32 id):_id(id){}
	__forceinline__ __host__ __device__ bool operator()(const cullingContext& c)
	{
...
struct is_not_frustum
{
	__forceinline__ __host__ __device__ bool operator()(const TriFrustum& c)
	{
...
struct is_negtive
{
	__forceinline__ __host__ __device__ bool operator()(const unsigned& c)
	{
		return c == uint32(-1);
	}
};
