...
// our specialization goes here...
{
	...
	template<>
	class vector<BVHFlatNode>
		: public _Vector_val<BVHFlatNode,allocator<BVHFlatNode>>
	{	// varying size array of values
public:
	typedef BVHFlatNode _Ty;
	typedef allocator<BVHFlatNode> _Ax;
	typedef vector<_Ty, _Ax> _Myt;
	typedef _Vector_val<_Ty, _Ax> _Mybase;
	typedef  _Mybase::_Alty _Alloc;
